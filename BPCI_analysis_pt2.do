...
table year medicare, c(mean snf)
table year medicare, c(mean rehab)
table year medicare, c(mean ltc)
...
table year bpci, c(mean snf)
table year bpci, c(mean rehab)
table year bpci, c(mean ltc)
